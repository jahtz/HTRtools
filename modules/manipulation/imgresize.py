...
def imgresize(input_dir: Path, output_dir: Path | None, input_regex: str, output_suffix: str | None, height: int) -> None:
...
@click.command('imgresize', short_help='Resizes images.')
...
def imgresize_cli(input_dir: str, output_dir: str | None, input_regex: str, output_suffix: str | None, size: int) -> None:
    """
    Resizes images.
